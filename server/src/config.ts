...
export class Config {
    debugLogging = 'debug';
    'server.port' = '8081';
    'jhipster.clientApp.name' = 'PetStore';
    ...
    'jhipster.mail.from' = 'PetStore@localhost';
    'jhipster.swagger.default-include-pattern' = '/api/.*';
    'jhipster.swagger.title' = 'PetStore API';
    'jhipster.swagger.description' = 'PetStore API documentation';
    ...
    'eureka.instance.appname' = 'PetStore';
    'eureka.instance.instanceId' = 'PetStore:${random.value}';
