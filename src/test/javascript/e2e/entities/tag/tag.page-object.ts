...
export class TagDeleteDialog {
  ...
  private dialogTitle: ElementFinder = element(by.id('petStoreApp.tag.delete.question'));
...
export default class TagComponentsPage {
  ...
  async deleteTag() {
    ...
    expect(await tagDeleteDialog.getDialogTitle().getAttribute('id')).to.match(/petStoreApp.tag.delete.question/);
