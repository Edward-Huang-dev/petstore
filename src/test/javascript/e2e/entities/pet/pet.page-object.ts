...
export class PetDeleteDialog {
  ...
  private dialogTitle: ElementFinder = element(by.id('petStoreApp.pet.delete.question'));
...
export default class PetComponentsPage {
  ...
  async deletePet() {
    ...
    expect(await petDeleteDialog.getDialogTitle().getAttribute('id')).to.match(/petStoreApp.pet.delete.question/);
