...
export class OrderDeleteDialog {
  ...
  private dialogTitle: ElementFinder = element(by.id('petStoreApp.order.delete.question'));
...
export default class OrderComponentsPage {
  ...
  async deleteOrder() {
    ...
    expect(await orderDeleteDialog.getDialogTitle().getAttribute('id')).to.match(/petStoreApp.order.delete.question/);
