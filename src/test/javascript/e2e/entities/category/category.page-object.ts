...
export class CategoryDeleteDialog {
  ...
  private dialogTitle: ElementFinder = element(by.id('petStoreApp.category.delete.question'));
...
export default class CategoryComponentsPage {
  ...
  async deleteCategory() {
    ...
    expect(await categoryDeleteDialog.getDialogTitle().getAttribute('id')).to.match(/petStoreApp.category.delete.question/);
