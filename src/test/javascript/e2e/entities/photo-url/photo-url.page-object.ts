...
export class PhotoUrlDeleteDialog {
  ...
  private dialogTitle: ElementFinder = element(by.id('petStoreApp.photoUrl.delete.question'));
...
export default class PhotoUrlComponentsPage {
  ...
  async deletePhotoUrl() {
    ...
    expect(await photoUrlDeleteDialog.getDialogTitle().getAttribute('id')).to.match(/petStoreApp.photoUrl.delete.question/);
